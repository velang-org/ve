...
impl CBackend {
    ...
    fn generate_ffi_declarations(&mut self, program: &ast::Program) -> Result<(), CompileError> {
        ...
        // Integer type to string functions
        self.header.push_str("static char* ve_i8_to_str(ve_i8 num) {\n");
        self.header.push_str("    char* buffer = malloc(8);\n");
        ...
        self.header.push_str("    char* buffer = malloc(24);\n");
        ...
        self.header.push_str("    char* buffer = malloc(16);\n");
